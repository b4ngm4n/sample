...
CREATE TABLE `jenis_pelayanans` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `jenis_pelayanans_uuid_unique` (`uuid`),
  UNIQUE KEY `jenis_pelayanans_slug_unique` (`slug`)
...
LOCK TABLES `jenis_pelayanans` WRITE;
/*!40000 ALTER TABLE `jenis_pelayanans` DISABLE KEYS */;
INSERT INTO `jenis_pelayanans` VALUES (4,'ca625635-9e74-4b6c-8dad-fbcfc696660b','BIAS','2024','bias-2024','2024-12-18 08:21:31','2024-12-18 08:32:50'),(5,'8f4a9a7a-1b01-42e5-9576-189087efd32d','BIASS','2024','biass-2024','2024-12-18 08:38:33','2024-12-18 08:38:33');
/*!40000 ALTER TABLE `jenis_pelayanans` ENABLE KEYS */;
UNLOCK TABLES;
