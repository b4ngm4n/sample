...
INSERT INTO `kategoris` VALUES (1,'20de0b74-effb-4cbc-a386-4bbe7bf5ff41','Imunisasi Dasar Lengkap 1','imunisasi-dasar-lengkap-1','pws','idl','Imunisasi Dasar Lengkap 1','2025-01-26 00:35:49','2025-01-26 00:35:49'),(2,'f149bd02-407d-4c6a-87cb-614f226ca06e','Imunisasi Baduta Lengkap 1','imunisasi-baduta-lengkap-1','pws','ibl','Imuinasasi Bayi Dua Tahun Lengkap','2025-01-26 00:35:49','2025-01-26 00:35:49'),(3,'c4f4acc5-d386-47f2-bc35-28798f30bf09','Imunisasi TT WUS Ibu Hamil','imunisasi-tt-wus-ibu-hamil','pws','tt+','Imunisasi Tetanus Toksoid (TT) pada WUS Ibu Hamil','2025-01-26 00:35:49','2025-01-29 20:45:46'),(5,'9123d08d-55e1-4e54-b2d7-1810c7dffb5d','Imunisasi Wus Tidak Hamil','imunisasi-wus-tidak-hamil','pws','tt+','Imunisasi Tetanus Toksoid (TT) pada WUS	Tidak Hamil','2025-01-29 20:46:25','2025-01-29 20:46:25'),(6,'d8b88707-25ac-47e6-907a-4ac77fac17b0','Sasaran Bayi Baru Lahir','sasaran-bayi-baru-lahir','pws','idl','Sasaran Untuk Data Bayi Baru Lahir','2025-01-30 14:04:36','2025-01-31 00:11:09'),(7,'8f582b19-0e80-46ad-9ed0-9367c9568cfe','Sasaran Surviving Infant','sasaran-surviving-infant','pws','idl','Sasaran Untuk Data Surviving Infant','2025-01-31 00:41:05','2025-01-31 00:41:05'),(8,'ce44eb5e-95cf-4476-86d1-4e7e3d203b87','Sasaran Baduta','sasaran-baduta','pws','ibl','Sasaran Untuk Data Bayi Dua Tahun','2025-01-31 00:42:29','2025-01-31 00:42:29'),(9,'23f7a26a-e2ff-4fd1-a612-93e6e406bf59','Sasaran Wus','sasaran-wus','pws','tt+','Sasaran Untuk Data WUS TT','2025-01-31 01:32:00','2025-01-31 01:32:00');
...
--
-- Table structure for table `pws_sasarans`
--

DROP TABLE IF EXISTS `pws_sasarans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pws_sasarans` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tahun_id` bigint unsigned NOT NULL,
  `kategori_id` bigint unsigned NOT NULL,
  `wilayah_kerja_id` bigint unsigned NOT NULL,
  `jumlah` int NOT NULL,
  `jenis_data` enum('l','p','ibu-hamil','tidak-hamil') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pws_sasarans_tahun_id_foreign` (`tahun_id`),
  KEY `pws_sasarans_kategori_id_foreign` (`kategori_id`),
  KEY `pws_sasarans_wilayah_kerja_id_foreign` (`wilayah_kerja_id`),
  CONSTRAINT `pws_sasarans_kategori_id_foreign` FOREIGN KEY (`kategori_id`) REFERENCES `kategoris` (`id`) ON DELETE CASCADE,
  CONSTRAINT `pws_sasarans_tahun_id_foreign` FOREIGN KEY (`tahun_id`) REFERENCES `tahuns` (`id`) ON DELETE CASCADE,
  CONSTRAINT `pws_sasarans_wilayah_kerja_id_foreign` FOREIGN KEY (`wilayah_kerja_id`) REFERENCES `wilayah_kerjas` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pws_sasarans`
--

LOCK TABLES `pws_sasarans` WRITE;
/*!40000 ALTER TABLE `pws_sasarans` DISABLE KEYS */;
/*!40000 ALTER TABLE `pws_sasarans` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-01-31 11:24:56
