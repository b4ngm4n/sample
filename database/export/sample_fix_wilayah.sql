...
CREATE TABLE `puskesmas` (
  ...
  `kode_puskesmas` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_puskesmas` enum('aktif','non-aktif') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'aktif',
...
-- Dump completed on 2024-12-11 23:12:22
