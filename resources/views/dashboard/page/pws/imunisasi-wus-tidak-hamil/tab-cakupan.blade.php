<div class="col-md-12">
   <div class="card">
      <div class="mb-0 mt-3 me-3">
         <button id="btnCakupanTidakHamil" class="btn btn-sm btn-outline-primary float-end"><i class="ti-download me-2"></i>Gambar</button>
      </div>
      <div class="card-body" id="tableCakupanTidakHamil">
