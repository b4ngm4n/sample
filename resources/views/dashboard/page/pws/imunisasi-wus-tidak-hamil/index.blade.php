       ...
       <div class="card-body">
           ...
           <div class="tab-content" id="myTabContent">
               <div class="tab-pane fade active show" id="inputan-tab-pane" role="tabpanel"
                   ...
                   @include('dashboard.page.pws.imunisasi-wus-tidak-hamil.tab-inputan')
               </div>

               <div class="tab-pane fade p-0 border-0" id="kumulatif-tab-pane" role="tabpanel" aria-labelledby="kumulatif-tab"
                   tabindex="0">
                   @include('dashboard.page.pws.imunisasi-wus-tidak-hamil.tab-cakupan')
               </div>
           </div>
       </div>
   </div>
...
@push('script')
    ...
    document.getElementById('btnCakupanTidakHamil').addEventListener('click', function () {
    ...
    function captureTable() {
        ...
        const tableContainer = document.getElementById('tableCakupanTidakHamil');
        ...
        title.textContent = "Laporan Cakupan Imunisasi WUS Tidak Hamil";
        ...
        html2canvas(tableContainer).then(function(canvas) {
            ...
            link.href = imgData;
            link.download = 'Cakupan_Imunisasi_WUS_Tidak_Hamil_' + currentDate + '.png';
            link.click();
        });
    }
