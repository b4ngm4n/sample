            ...
            <td>
               <div class="row">
                  ...
                  <div class="col-md-6">
                     ...
                     <input type="number" name="jumlah[{{ $kategori->id }}][{{ $wk->wilayah_id }}][tidak_hamil]"
                        class="form-control"
                  ...
                  <div class="col-md-6">
                     ...
                     <input type="number" name="jumlah[{{ $kategori->id }}][{{ $wk->wilayah_id }}][l]"
                        class="form-control" value="{{ $pwsSasaran[$kategori->id][$wk->wilayah_id]['l'] ?? '' }}">
                  </div>
                  <div class="col-md-6">
                     <label>P</label>
                     <input type="number" name="jumlah[{{ $kategori->id }}][{{ $wk->wilayah_id }}][p]"
                        class="form-control" value="{{ $pwsSasaran[$kategori->id][$wk->wilayah_id]['p'] ?? '' }}">
                  </div>
                  @endif
               </div>
            </td>
