               ...
               <tr>
                  ...
                  <td>
                     <div class="row">
                        @if ($kategori->status_kategori == 'tt+')
                        <div class="col-md-12">
                           <p>{{ isset($pwsSasaran[$kategori->id][$wk->wilayah->id]['ibu-hamil']) ?
                              ($pwsSasaran[$kategori->id][$wk->wilayah->id]['ibu-hamil'] +
                              $pwsSasaran[$kategori->id][$wk->wilayah->id]['tidak-hamil']) : 0 }}</p>
                        </div>
                        @else
                        <div class="col-md-12">
                           <p>{{ isset($pwsSasaran[$kategori->id][$wk->wilayah_id]['l']) ?
                              ($pwsSasaran[$kategori->id][$wk->wilayah_id]['l'] +
                              $pwsSasaran[$kategori->id][$wk->wilayah_id]['p']) : 0 }}</p>
                        </div>
                        @endif
                     </div>
                  </td>
