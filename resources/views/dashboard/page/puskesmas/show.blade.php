   ...
   <div class="card">
      <div class="card-body">
         <div class="card-title">
            <h4 class="card-title">DETAIL PUSKESMAS</h4>
         </div>
         <div class="row mb-4">
            <label for="nama-puskesmas" class="col-sm-3 col-form-label">Nama Puskesmas</label>
            <div class="col-sm-9">
               <input type="text" class="form-control" id="nama-puskesmas" value="{{ $puskesmas->nama_puskesmas }}" readonly>
            </div>
         </div>
         <div class="row mb-4">
            <label for="kode-puskesmas" class="col-sm-3 col-form-label">Kode puskesmas</label>
            <div class="col-sm-9">
               <input type="email" class="form-control" id="kode-puskesmas" value="{{ $puskesmas->kode_puskesmas }}" readonly>
            </div>
         </div>

         <a href="{{ route('puskesmas.index') }}" class="btn btn-primary w-md"><i class="ti-arrow-left me-3"></i>Kembali</a>
      </div>
   </div>
</div>
   ...
   <div class="card">
         ...
         <div class="offcanvas offcanvas-end" tabindex="-1" id="tambahKabupaten" aria-labelledby="tambahKabupatenLabel">
            ...
            <div class="offcanvas-body p-4">
               <form action="{{ route('kabupaten.store') }}" method="POST">
                  @csrf
                  <input type="text" name="puskesmas" value="{{ $puskesmas->uuid }}" hidden>
                  <div class="mb-3">
      ...
      <div class="card-body">
         <table id="selection-datatable"
            ...
            <tbody>
               @foreach ($puskesmas->kabupatens as $kabupaten)
               <tr>
