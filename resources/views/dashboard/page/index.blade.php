  ...
  <div class="container-fluid">
      <div class="row g-4">
                      ...
                      <div class="card">
                          <div class="card-body">
                              ...
                              <div id="shareId">
                                  <!-- Single Card -->
                                  <div
                                      class="share-file-card d-flex justify-content-between align-items-center">
                                      <div class="share-file-info d-flex align-items-center">
                                          <div class="share-file-img">
                                              <img src="img/shop-img/1.png" alt="">
                                          </div>
                                          <div class="share-file-name">
                                              <h6>New Eco Amazon Sound</h6>
                                              <a href="index-2.html#">Ajoy <Span>Just Now</Span></a>
                                          </div>
                                      </div>
                                      <div class="share-act-btn">
                                          <a class="alert alert-primary px-2 py-1"
                                              href="index-2.html#"><i class='bx bxs-edit'></i></a>
                                          <a class="alert alert-danger px-2 py-1" href="index-2.html#"><i
                          ...
                          <div class="card-body">
                              <div
                                  ...
                                  <div class="dashboard-dropdown">
                                      <div class="dropdown">
                                          <button class="btn dropdown-toggle" type="button"
                                              id="dashboardDropdown3" data-bs-toggle="dropdown"
                                              aria-haspopup="true" aria-expanded="false"><i
                                                  class="ti-more"></i></button>
                                          <div class="dropdown-menu dropdown-menu-right"
                                              aria-labelledby="dashboardDropdown3">
                                              <a class="dropdown-item" href="index-2.html#"><i
                                                      class="ti-pencil-alt"></i>
                                                  Edit</a>
                                              <a class="dropdown-item" href="index-2.html#"><i
                              ...
                              <div id="activeUser">
                                  <!-- Single card -->
                                  <div
                                      class="single-active-user d-flex justify-content-between align-items-center">
                                      <div class="d-flex">
                                          <div class="active-user-img">
                                              <img src="img/bg-img/per-3.jpg" alt="">
                                          </div>
                                          <div class="active-user-info">
                                              <a href="index-2.html#">Ajoy Chandra</a>
                                              <p>Developer</p>
                                          </div>
                                      </div>
                                      <div class="active-act-btn">
                                          <a class="btn btn-success rounded-pill"
                                              href="index-2.html#">Start</a>
                                      </div>
                                  </div>
                                  ...
                                  <div
                                      ...
                                      <div class="d-flex">
                                          ...
                                          <div class="active-user-info">
                                              <a href="index-2.html#">jhon Deo</a>
                                              <p>Developer</p>
                                          </div>
                                      </div>
                                      <div class="active-act-btn">
                                  ...
                                  <div
                                      ...
                                      <div class="d-flex">
                                          ...
                                          <div class="active-user-info">
                                              <a href="index-2.html#">Litana Agel</a>
                                              <p>Developer</p>
                                          </div>
                                      </div>
                                      <div class="active-act-btn">
          ...
          <div class="col-lg-4 col-xxl-3">
              ...
              <!-- Widget Content -->
              <div class="card widget-new-content mb-25">
                  <div class="card-body">
                      ...
                      <div class="progress h-5">
                          <div class="progress-bar w-25 bg-success" role="progressbar"
              ...
              <div class="card">
                  <div class="card-body chat-application">
                              ...
                              <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right"
                                      ...
                                      <a class="dropdown-item" href="index-2.html#"><i
                                              class="ti-settings"></i>
                                          Settings</a>
                                      <a class="dropdown-item" href="index-2.html#"><i class="ti-eraser"></i>
                                          Remove</a>
                                      <a class="dropdown-item" href="index-2.html#"><i
                                              class='bx bx-trash'></i>
                                          Delete</a>
                          ...
                          <div class="chats">
                              <div class="chat">
                                  <div class="chat-avatar">
                                      <a class="avatar" href="index-2.html#">
                              ...
                              <div class="chat chat-left">
                                  ...
                                  <div class="chat-body">
                                      <div class="chat-content">
                                          <p>Hey Jacob, Could you please help me to find it out?
                                          </p>
                                      </div>
                                  </div>
                              </div>
                      ...
                      <form class="chat-app-input mt-3 row">
                          <div class="col-12">
                              <div class="input-group position-relative has-icon-left">
                                  <input type="text" class="form-control border-light chat-form"
                                      placeholder="Send message">

                                  <div class="input-group-append">
                                      <button class="btn btn-primary chat-btn" type="button">Send
                              ...
                              <tbody>
                                  <tr>
                                      ...
                                      <td><a href="index-2.html#!"
                                              class="badge text-bg-success badge-pill">Active</a>
                                      </td>
                                      <td class="text-right"><a href="index-2.html#!"><i
                                  ...
                                  <tr>
                                      ...
                                      <td>Nov 13, 2023</td>
                                      <td>$2334</td>
                                      <td><a href="index-2.html#!" class="badge text-bg-danger badge-pill">Not
                                              Active</a></td>
                                      <td class="text-right"><a href="index-2.html#!"><i
                                                  class="fa fa-star f-18 text-warning"></i></a>
                                          <a href="index-2.html#!"><i
