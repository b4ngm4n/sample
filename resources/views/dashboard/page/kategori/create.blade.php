      ...
      <div class="card-body">
         ...
         <form action="{{ route('kategori.store') }}" method="POST">
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" placeholder="Imunisasi TT WUS Tidak Hamil" required>
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Apapun Itu">
