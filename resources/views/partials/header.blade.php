      ...
      <ul class="right-side-content d-flex align-items-center">
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu language-dropdown dropdown-menu-right">
                  <div class="user-profile-area">
                      <a href="index.html#" class="dropdown-item mb-15"><img src="img/core-img/l5.jpg"
                              alt="Image" />
                          <span>USA</span></a>
                      <a href="index.html#" class="dropdown-item mb-15"><img src="img/core-img/l2.jpg"
                              alt="Image" />
                          <span>German</span></a>
                      <a href="index.html#" class="dropdown-item mb-15"><img src="img/core-img/l3.jpg"
                              alt="Image" />
                          <span>Italian</span></a>
                      <a href="index.html#" class="dropdown-item"><img src="img/core-img/l4.jpg"
                              alt="Image" />
                          <span>Russian</span></a>
                  </div>
              </div>
          ...
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu profile dropdown-menu-right">
                  <!-- User Profile Area -->
                  <div class="user-profile-area">
                      <a href="index.html#" class="dropdown-item"><i class="bx bx-user font-15"
                              aria-hidden="true"></i> My
                          profile</a>
                      <a href="index.html#" class="dropdown-item"><i class="bx bx-wallet font-15"
                              aria-hidden="true"></i>
                          My wallet</a>
